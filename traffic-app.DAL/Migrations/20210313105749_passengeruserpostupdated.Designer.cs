...
namespace traffic_app.DAL.Migrations
{
    ...
    [Migration("20210313105749_passengeruserpostupdated")]
    partial class passengeruserpostupdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("traffic_app.Entity.Entities.Message", b =>
                {
            ...
            modelBuilder.Entity("traffic_app.Entity.Entities.OnTheWayDriverPost", b =>
                {
                    b.Property<int>("OnTheWayDriverPostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OnTheWayDriverPostId");

                    b.HasIndex("UserId");

                    b.ToTable("OnTheWayDriverPosts");
                });

            modelBuilder.Entity("traffic_app.Entity.Entities.OnTheWayPassengerPost", b =>
                {
                    b.Property<int>("OnTheWayPassengerPostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("PaymentForEachPassenger")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("OnTheWayPassengerPostId");

                    b.HasIndex("UserId");

                    b.ToTable("OnTheWayPassengerPosts");
                });
